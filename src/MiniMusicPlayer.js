...
const MiniMusicPlayer = ({ onAudioRef }) => {
  ...
  const playlist = [
    ...
    { name: "Let Down", artist: "Radiohead", src: "https://xapopyizznjubyostnxn.supabase.co/storage/v1/object/public/Medos%20webb/covers/Radiohead%20-%20Let%20Down.mp3", cover: "https://xapopyizznjubyostnxn.supabase.co/storage/v1/object/public/Medos%20webb/covers/let%20down.jpg" },
