...
const MiniMusicPlayer = ({ onAudioRef }) => {
  ...
  const playlist = [
    ...
    { name: "Let Down", artist: "Radiohead", src: "https://xapopyizznjubyostnxn.supabase.co/storage/v1/object/public/Medos%20webb/Radiohead%20-%20Let%20Down.mp3", cover: "https://xapopyizznjubyostnxn.supabase.co/storage/v1/object/public/Medos%20webb/covers/let%20down.jpg" },
    ...
    { name: "Forever", artist: "The Little Dippers", src: "https://xapopyizznjubyostnxn.supabase.co/storage/v1/object/public/Medos%20webb/Forever.mp3", cover: "https://xapopyizznjubyostnxn.supabase.co/storage/v1/object/public/Medos%20webb/covers/forever.jpg" }
  ];
                ...
                <div>
                  <div className="flex items-start justify-between">
                    <div className="flex-1 min-w-0 mr-2">
                      ...
                      <p className="text-xs text-white/90 truncate drop-shadow">{currentTrack.artist}</p>
                    </div>
